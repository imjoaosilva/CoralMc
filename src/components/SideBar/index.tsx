...
import { FaHouseUser, FaUserEdit, FaGlobeEurope } from 'react-icons/fa';
...
export const SideBar = () => {
    ...
    return (
        <>
            ...
            >
                {!isOpen ? <GiHamburgerMenu color={"9CA3AF"} size={25}/> : <IoClose color={"9CA3AF"} size={30}/> }
            </C.MobileIcon>
            <C.Container isOpen={isOpen}>
                ...
                <C.SideBarFooter>
                    <GiSettingsKnobs color={"9CA3AF"} size={17}/>
                    <FaGlobeEurope color={"9CA3AF"} size={17}/>
                    <CiSettings color={"9CA3AF"} size={20}/>
                </C.SideBarFooter>
            </C.Container>
        </>
    )
